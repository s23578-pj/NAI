"""
======================================================
Chlorophyll Level for Chives and Chestnut with Support Vector Machine (SVM)
======================================================
...
print("\n" + "+"*120)
print("\nMetrics related to the quality of the classification of chlorophyll A and B support vector classifier model on training dataset\n")
