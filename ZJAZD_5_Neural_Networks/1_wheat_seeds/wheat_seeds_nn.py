"""
======================================================
Neural Network for Wheat Seeds Classification
======================================================
Authors:
Alicja Szczypior
Krzysztof Szczypior
...
The dataset used in this script is loaded from the "wheat_seeds.csv" file.
It contains information about various features of wheat seeds.
...
In this example, we are using a neural network for the classification of wheat seeds into three classes.
...
wheat_ds = pd.read_csv("wheat_seeds.csv", sep=",")

X, y = wheat_ds.iloc[:, 0:-1], wheat_ds.iloc[:, -1]

# Separate input data into two classes based on labels
class_1 = np.array(X[y == 1.0])
class_2 = np.array(X[y == 2.0])
class_3 = np.array(X[y == 3.0])
